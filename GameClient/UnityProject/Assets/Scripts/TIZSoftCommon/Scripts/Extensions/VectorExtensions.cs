...
namespace TIZSoft.Extensions
{
    public static class VectorExtensions
    {
        ...
        public static Vector3 ScreenPointToWorld(this Camera camera, Vector3 point)
        {
            return ScreenPointToWorld(camera, point, 100F);
        }

        public static Vector3 ScreenPointToWorld(this Camera camera, Vector3 point, float castDistance)
        {
