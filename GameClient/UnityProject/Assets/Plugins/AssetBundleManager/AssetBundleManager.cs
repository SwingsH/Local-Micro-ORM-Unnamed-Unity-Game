    ...
    public class AssetBundleManager : MonoBehaviour
    {
        ...
        protected bool LoadAssetBundleInternal(string assetBundleName, bool isLoadingAssetBundleManifest)
        {
            ...
            else
            {
                ...
                var isFromStreamingAssets = bundleBaseDownloadingURL.StartsWith(Application.streamingAssetsPath);
                ...
                else
                {
                    ...
                    if (isAssetBundleValid)
                    {
                        ...
                        {
                            webRequest = assetBundleHash.isValid
                                ? UnityWebRequestAssetBundle.GetAssetBundle(url, assetBundleHash, 0)
        ...
        public AssetBundleLoadAssetOperation LoadAssetAsync(string assetBundleName, string assetName, System.Type type)
        {
            ...
            if (SimulateAssetBundleInEditor)
            {
                ...
                string[] assetPaths = AssetDatabase.GetAssetPathsFromAssetBundleAndAssetName(assetBundleName.ToLower(), assetName);
